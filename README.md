...
**توسعه نوآوران جنوب** — Tosee Noavaran Jonoub

یک سیستم کامل IoT برای شمارش، طبقه‌بندی و تحلیل تردد خودروها با استفاده از سنسورهای القایی/مغناطیسی

> **ترددشمار dsPIC30F4011:** حافظهٔ محلی این دستگاه از کارت حافظه به فلش SPI مدل
> `W25Q64JVS` تغییر کرده است. راهنمای کامل مهاجرت، پروگرام کردن میکروی SMD با PICkit 3 و
> کد فعال‌سازی را در [`firmware/W25Q64_MIGRATION_FA.md`](firmware/W25Q64_MIGRATION_FA.md) ببینید.
